...
Route::middleware('auth:sanctum')->group(function () {
    ...
    Route::get('/feedbackAnswer/{id}', [FeedbackController::class, 'showFeedbackAnswer']);
    Route::get('/FeedbackQuestionAns/{id}', [FeedbackController::class, 'showFeedbackQuestionAns']);
});
